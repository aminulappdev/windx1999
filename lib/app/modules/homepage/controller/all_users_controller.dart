...
import 'package:windx1999/app/modules/homepage/model/all_users_model.dart';
...
class AllUsersController extends GetxController {
  ...
  List<AllUsersItemModel>? get allUsersData => allUsersModel?.data;
  ...
  Future<bool> getAllUsers() async {
    ...
    if (response.isSuccess) {
      allUsersModel = AllUsersModel.fromJson(response.responseData);
      _errorMessage = null;
      isSuccess = true;
    } else {
