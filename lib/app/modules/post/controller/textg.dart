...
//                       }
//                       if (allPostController.allPostData == null ||
//                           allPostController.allPostData!.isEmpty) {
...
//     if (isSuccess) {
//       int index = allPostController.allPostData
//               ?.indexWhere((post) => post.contentMeta?.id == postId) ??
//           -1;
//       if (index != -1 && allPostController.allPostData != null) {
//         int currentLikes =
//             allPostController.allPostData![index].contentMeta?.like ?? 0;
